...
.checked_updates {
    ...
    const panelHTML = policy
        ? policy.createHTML(`
            ...
            <a href="https://github.com/LillyPK/PK-s-tool/blob/main/PKs%20tool.js" target="_blank" class="checked_updates">🔄️</a>
      ...
      if (addButton != undefined && validoBotones) {
        ...
        if (checked_updates != undefined) {
          checked_updates.onclick = () => {
            window.open(
              `https://github.com/LillyPK/PK-s-tool/blob/main/PKs%20tool.js`
            );
          };
        }
